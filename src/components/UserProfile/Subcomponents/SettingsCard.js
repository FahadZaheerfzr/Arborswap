    ...
    <div className="w-full p-5 md:p-9 bg-white dark:bg-black-shade2-background rounded-[10px] ">
      ...
      <div className="mt-10">
        ...
        <div className="mt-5 flex items-center">
          ...
          <input
            className="bg-transparent w-full pl-14 pr-5 py-4 font-gilroy placeholder:font-medium placeholder:text-light-text font-semibold text-dark-text dark:text-dark-white-color focus:outline-none border-[1.5px] rounded-lg border-light-text border-opacity-50"
            type={'text'}
        ...
        <div className="mt-5 flex items-center">
          ...
          <input
            className="bg-transparent w-full pl-14 pr-8 py-4 font-gilroy placeholder:font-medium placeholder:text-light-text font-semibold text-dark-text dark:text-dark-white-color focus:outline-none border-[1.5px] rounded-lg border-light-text border-opacity-50"
            type={'text'}
