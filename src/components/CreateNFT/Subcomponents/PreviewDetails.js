...
export default function PreviewDetails({ name, value, icon, verified }) {
    return (
        <div className='py-5 flex justify-between border-b border-dashed border-light-text border-opacity-30'>
            <span className='font-gilroy text-sm font-medium text-[#807373] dark:text-dark-gray'>
                {name}
            </span>
            ...
            <div className='flex items-center'>
                ...
                {verified && <img className="w-[14px] h-[14px] ml-1" src="/images/home/collections/cards/verified.svg" alt="verified" />}
            </div>
        </div>
    )
}
