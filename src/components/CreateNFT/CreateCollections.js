                ...
                <div className='mt-4 py-6 px-5'>
                    ...
                    <div className='flex items-center gap-5 mt-5'>
                        ...
                        <div className='w-full flex flex-col items-center text-center'>
                            ...
                            <button className='bg-light-gray-shade dark:bg-dark-background mt-2 flex gap-2 py-[10px] px-5'
                                onClick={triggerFile}>
                    ...
                    <div className='mt-10'>
                        ...
                        <input className='bg-transparent w-full mt-5 px-5 py-4 font-gilroy placeholder:font-medium placeholder:text-light-text font-semibold text-dark-text dark:text-dark-white-color focus:outline-none border-[1.5px] rounded-lg border-light-text border-opacity-50' type={"text"} placeholder="Enter Name"
