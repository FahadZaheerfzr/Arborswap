    ...
    return (
        <div className={`${Styles.card} flex w-full`}>
            ...
            <div className='w-1/2 flex flex-col py-4 px-4'>
                <div className='name'>
                    <span className='font-gilroy font-semibold text-sm'>
                        {card_name}
                    </span>
                </div>
                ...
                <div className='price mt-3'>
                    <span className='font-medium font-gilroy text-xs text-light-text'>
                        Listed Price
                    </span>
                </div>
                ...
                <div className='flex mt-1'>
                    ...
                    <span className='ml-2 font-gilroy font-bold text-sm text-dark-text'>
                        {listed_price}
                    </span>
                </div>
