      ...
      <div className="card-info px-5 py-5">
        ...
        <div className="flex justify-between mt-2">
          <div className="card-items flex items-center">
            <img className="w-7 h-7 mr-1 xl:mr-3" src={card_icon} alt={card_name} />
            <span
          ...
          <div className="floor-price flex items-center md:mt-2 lg:mt-0">
            ...
            <span className="ml-2 font-gilroy font-bold text-dark-text dark:text-dark-white-color">{floor_price}</span>
          </div>
        </div>
      </div>
    </div>
