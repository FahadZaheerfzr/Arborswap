  ...
  return (
    <div className='flex w-full mt-3 justify-between bg-white dark:bg-black-shade2-background rounded-[10px] px-10 py-5'>
      <div className='flex items-center w-1/4'>
          ...
          rank === 1 ?
            ...
            : rank === 2 ?
              ...
              : rank === 3 ?
                ...
                :
                rank && <div className='w-10 h-10 flex text-center justify-center items-center mr-2'>
        ...
        <span className='ml-5 font-gilroy font-bold text-dark-text dark:text-dark-white-color '>
          {card_name}
        </span>
      ...
      <div className='flex items-center w-3/4 justify-around'>
        <div className='key-value'>
          <div className='key flex'>
            <span className='font-gilroy font-medium text-[#807373] dark:text-dark-gray text-xs'>
              Floor Price
            </span>
        ...
        <div className='key-value'>
          ...
          <div className='value flex items-center mt-1'>
            ...
            <span className='font-gilroy font-bold text-dark-text dark:text-[#1B8552] text-sm'>
              {change}
            </span>
          </div>
        </div>
