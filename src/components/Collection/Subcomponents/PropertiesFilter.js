  ...
  return (
    <div className="price-filters px-3 py-6">
      <div className="search flex items-center">
        ...
        <input
          className="w-full -ml-7 rounded-md py-3 pl-10 font-gilroy font-medium bg-[#FAF8F5] placeholder:text-[#707070] focus:outline-none"
          type="text"
      ...
      <div className="mt-3">
        {filters.map((filter) => (
          <div className="filter  border-b border-dashed border-light-text border-opacity-30">
            <div
              className="filter-name py-4 flex items-center cursor-pointer justify-between"
            ...
            >
              ...
              <ArrowDownSVG
                className={`dark:fill-dark-white-color ${dropdowns[filter.id] ? 'rotate-180' : 'rotate-0'}`}
                alt="arrow-down"
              />
            </div>
            {dropdowns[filter.id] &&
