  ...
  return (
    <div className="bg-white w-full rounded-2xl pb-5 mb-3">
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-col ml-4">
              <div className="flex items-center gap-1">
                <span className="font-gilroy font-bold text-dark-text">{card_name}</span>
                <img src="/images/home/collections/cards/verified.svg" alt="verified" />
              </div>
              <span className="font-gilroy font-medium text-sm text-light-text">{item_quantity.toLocaleString()}</span>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between mx-5 mt-5">
        <span className="font-gilroy font-medium text-[#807373] dark:text-dark-gray text-sm">Floor Price</span>

        <div className="value flex items-center">
          <img src={card_category_icon} alt="category-icon" className="mr-2" />
          <span className="font-gilroy font-bold text-dark-text text-sm">{floor_price}</span>
        </div>
      </div>
      <div className="flex items-center justify-between mx-5 mt-5">
        <span className="font-gilroy font-medium text-[#807373] dark:text-dark-gray text-sm">Volume</span>

        <div className="value flex items-center">
          <img src={card_category_icon} alt="category-icon" className="mr-2" />
          <span className="font-gilroy font-bold text-dark-text text-sm">{volume}</span>
        </div>
      </div>
    </div>
  )
