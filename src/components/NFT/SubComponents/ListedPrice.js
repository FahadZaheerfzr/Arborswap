...
export default function ListedPrice({ image, listed_price, second_price, highest_bid }) {
    return (
        <div className='bg-white rounded-[20px] w-full px-9 py-9'>
            <div className='flex justify-between'>
                ...
                <div className={`flex items-center px-2 py-1 ${Styles.cardBox}`}>
                    ...
                    <span className='font-gilroy font-medium text-xs text-[#807373]'>
                        1 of 300
                    </span>
                </div>
            </div>
            ...
            <div className='flex items-center mt-5'>
                ...
                <span className='font-gilroy font-bold text-2xl text-dark-text'>
                    {listed_price}
                    <span className='font-medium text-sm text-[#807373]'>
                        &nbsp;(${second_price})
                    </span>
                </span>
            </div>
            ...
            <div className='flex items-center mt-7'>
                <img src="/images/nft/bid.svg" alt="bid" className='mr-2' />
                <span className='font-gilroy font-medium text-sm text-[#807373]'>
                    Highest Bid
                </span>

                <span className='font-gilroy font-semibold text-sm text-[#807373] ml-2'>
                    {highest_bid} BNB
                </span>
            </div>
            ...
            <div className='flex w-full mt-10'>
                <button className='bg-light-text bg-opacity-30 py-4 w-full rounded-md font-gilroy font-bold  flex items-center justify-center'>
                    <img src='/images/nft/bid.svg' alt="bid" />
