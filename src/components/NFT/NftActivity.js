        ...
        <div className='w-full flex flex-col justify-center bg-white dark:bg-black-shade2-background rounded-[20px] mt-2 md:mt-10'>
            <div className='h-12 mt-2 flex w-full justify-around'>
                <div className={` h-full w-14 md:w-[84px] flex items-center justify-center ml-4 ${activeTab === "info" ? "border-b-2 border-primary-green border-opacity-50" : null}`}
                    ...
                    <span className={`font-gilroy cursor-pointer font-bold ${activeTab === "info" ? "text-primary-green" : "text-light-text dark:text-dark-text-color hover:text-primary-green"}`}>
                        Info
                    </span>
                </div>
                ...
                <div className={` h-full w-14 md:w-[84px] flex items-center justify-center ml-4 ${activeTab === "bids" ? "border-b-2 border-primary-green border-opacity-50" : null}`}
                    ...
                    <span className={`font-gilroy cursor-pointer font-bold ${activeTab === "bids" ? "text-primary-green" : "text-light-text dark:text-dark-text-color hover:text-primary-green"}`}>
                        Bids
                    </span>
                </div>
                ...
                <div className={` h-full w-14 md:w-[84px] flex items-center justify-center ml-4 ${activeTab === "activity" ? "border-b-2 border-primary-green border-opacity-50" : null}`}
                    ...
                    <span className={`font-gilroy cursor-pointer font-bold ${activeTab === "activity" ? "text-primary-green" : "text-light-text dark:text-dark-text-color hover:text-primary-green"}`}>
                        Activity
                    </span>
                </div>
            ...
            <div className='mt-4 mb-4'>
                ...
                {info && activeTab === "info" && (
                    <div className='flex flex-col px-5 py-5'>
                        <span className='font-gilroy font-bold text-[#807373] dark:text-dark-gray'>
                            Properties
                        </span>
                        ...
                        <div className='grid grid-cols-3 gap-5 mt-5'>
                            {info.map((info) => (
                                info.info.map((my_info, index) => (
                                    <div key={index} className='flex flex-col bg-[#FAF8F5] dark:bg-black-shade3-background rounded-md p-[14px]'>
                        ...
                        <span className='mt-10 font-gilroy font-bold text-[#807373] dark:text-dark-gray'>
                            Details
                        </span>
